...
class SASRecModel(SequentialRecommender):
    ...
    def calculate_loss(self, input_ids, answers, neg_answers, same_target, user_ids):
        ...
        pos_labels, neg_labels = torch.ones(pos_logits.shape, device=seq_out.device), torch.zeros(
            neg_logits.shape, device=seq_out.device)

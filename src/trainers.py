...
class Trainer:
    def __init__(self, model, train_dataloader, eval_dataloader, test_dataloader, args, logger):
        ...
        self.generative_model = isinstance(
            model, GenerativeSequentialRecommender)
    ...
    def get_full_sort_score(self, epoch, answers, pred_list):
        ...
        return [recall[0], recall[1], recall[3],
                ndcg[0], ndcg[1],  ndcg[3]], str(post_fix)
    ...
    def iteration(self, epoch, dataloader, train=True):
        ...
        if train:
            ...
            for i, batch in rec_data_iter:
                ...
                try:
                    rating_pred[self.args.train_matrix[batch_user_index].toarray()
                                > 0] = 0
                except:  # bert4rec
                ...
                arr_ind = rating_pred[np.arange(
                    len(rating_pred))[:, None], ind]
